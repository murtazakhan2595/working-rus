...
const ChartTooltipContent = React.forwardRef((
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    if (labelFormatter) {
      return (
        (<div className={cn("font-medium text-neutral-1100", labelClassName)}>
    ...
    return <div className={cn("font-medium text-neutral-1100", labelClassName)}>{value}</div>;
  }, [
    label,
    labelFormatter,
    payload,
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  ...
                  <div
                    ...
                    {item.value && (
                      <span
                        className="font-mono font-medium tabular-nums .text-slate-900 dark:text-slate-50">
