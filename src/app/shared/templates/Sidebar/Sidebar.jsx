                                    ...
                                    {child.children ? (
                                      <div>
                                        <div
                                          ...
                                          className={`rounded-t-lg flex items-center justify-between py-2 px-2 mt-2 hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
                ...
                {userProfile.role !== 3 && (
                  <>
                    <li
                      ...
                      className={`flex group mt-2 justify-between hover:bg-[#DAEFF8] hover:text-[#0D2282] py-2 px-2 items-center gap-1 cursor-pointer ${
                        isProjectOpen
                          ? "bg-[#DAEFF8] text-[#0D2282]"
                          : "text-[#5C5E64]"
                      } ${isSidebarOpen ? "rounded-t-lg" : "rounded-lg"}`}
                    >
                      <div className="flex gap-x-2">
                        <div className="flex flex-col items-center">
                          ...
                          />{" "}
                          <p
                            className={`text-center ml-2 text-xs transition-opacity duration-300 ${
                              isSidebarOpen
                                ? "hidden"
                                : "hidden group-hover:block group-hover:opacity-100"
                            }`}
