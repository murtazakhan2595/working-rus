...
const HrRole = ({ isSidebarOpen }) => {
  const activeLink = `flex rounded-md my-1 py-1.5 ${
    !isSidebarOpen ? "px-1" : "px-4"
  } items-center gap-x-1 bg-[#DAEFF8] text-[#5C5E64]`;
  const normalLink = `flex rounded-md my-1 py-1.5 ${
    !isSidebarOpen ? "px-1" : "px-4"
  } items-center gap-x-1 text-[#5C5E64] hover:border hover:border-blue-300 text-[10px]`;
  const ComingActiveLink = `flex rounded-md my-1 py-1.5 ${
    !isSidebarOpen ? "px-1" : "px-4"
  } items-center gap-x-1 text-[#5C5E64]`;
    ...
    <>
      <li className="group">
        <NavLink
          to="/"
          className={({ isActive }) =>
            `group flex mb-3 mt-5 rounded-md py-2 px-2 items-center gap-x-2 text-[#5C5E64] hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
              isActive ? "bg-[#DAEFF8] text-[#0D2282]" : ""
            }`
          }
        >
          <div className="flex flex-col">
            ...
            <p
              className={`text-xs text-center ml-[5px] transition-opacity duration-300 ${
                isSidebarOpen
                  ? "hidden"
          ...
          <p
            className={`overflow-hidden text-[14px] transition-all ${
        ...
        {!isSidebarOpen && (
          <div
            className="absolute rounded-md top-24 ml-20
bg-white w-40 text-sm
invisible opacity-20 -translate-x-3 transition-all
group-hover:visible group-hover:opacity-100 group-hover:translate-x-0 z-50  shadow-bottom"
          >
            <p className="m-1 px-2 py-1 rounded-lg text-[#5C5E64] hover:bg-[#DAEFF8] hover:text-[#0D2282]">
              <Link to="/">Home</Link>
            </p>
          </div>
        )}
      ...
      <li className="group">
        <div
          ...
          className={`flex items-center justify-between py-2 px-2 mt-2 hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
            isDbOpen ? "bg-[#DAEFF8] text-[#0D2282]" : "text-[#5C5E64]"
          } ${isSidebarOpen ? "rounded-t-lg" : "rounded-lg"} cursor-pointer `}
        >
          <div className="flex flex-col justify-center">
            <GoPeople
              className={`text-xl mr-3 ${!isSidebarOpen ? "ml-[12px]" : ""}`}
            />
            <p
        ...
        {!isSidebarOpen && (
          <div
            className="absolute rounded-lg border border-gray-100 top-40 ml-20
...
group-hover:visible group-hover:opacity-100 group-hover:translate-x-0 z-50 shadow-bottom"
      ...
      {isDbOpen && isSidebarOpen && (
        <div className="flex flex-col bg-[#F7F8FA]">
          ...
          <NavLink
            to="/coming-soon"
            className={({ isActive }) =>
              isActive ? ComingActiveLink : normalLink
            }
          >
          ...
          >
            <p className="text-sm px-2">Exit & Clearance</p>
          </NavLink>
          <NavLink
            to="/add-employee"
            className={({ isActive }) => (isActive ? activeLink : normalLink)}
      ...
      <li className="group">
        <div
          ...
          className={`flex items-center justify-between py-2 px-2 mt-2 hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
            isServiceHubOpen ? "bg-[#DAEFF8] text-[#0D2282]" : "text-[#5C5E64]"
          } ${isSidebarOpen ? "rounded-t-lg" : "rounded-lg"} cursor-pointer `}
        >
          <div className="flex flex-col justify-center">
            <GoPerson
          ...
          >
            ...
            <FaAngleDown
              className={`text-xs transition-transform duration-300 ${
                isServiceHubOpen ? "transform rotate-180" : ""
              }`}
            />
          </span>
        </div>
        ...
        {!isSidebarOpen && (
          <div
            className="absolute rounded-lg border border-gray-1 top-40 ml-20
...
group-hover:visible group-hover:opacity-100 group-hover:translate-x-0 z-50 shadow-bottom"
      ...
      <li className="group">
        <div
          ...
          className={`flex items-center justify-between mt-2 py-2 px-2 hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
            isLeaveOpen ? "bg-[#DAEFF8] text-[#0D2282]" : "text-[#5C5E64]"
          } ${isSidebarOpen ? "rounded-t-lg" : "rounded-lg"} cursor-pointer`}
        >
          <div className="flex flex-col justify-center">
            <LuCalendarDays
          ...
          >
            ...
            <FaAngleDown
              className={`text-xs transition-transform duration-300 ${
                isLeaveOpen ? "transform rotate-180" : ""
              }`}
            />
          </div>
        </div>
        {!isSidebarOpen && (
          <div
            className="absolute rounded-lg border border-gray-1 top-56 ml-20
bg-white w-44 text-base
invisible opacity-20 -translate-x-3 transition-all
group-hover:visible group-hover:opacity-100 group-hover:translate-x-0 z-50  shadow-bottom"
          >
      ...
      <li className="group">
        ...
        {!isSidebarOpen && (
          <div
            className="absolute rounded-lg border border-gray-1 top-52 ml-20
bg-white w-44 text-base
invisible opacity-20 -translate-x-3 transition-all
group-hover:visible group-hover:opacity-100 group-hover:translate-x-0 z-50 shadow-bottom"
          >
      ...
      <li className="group">
        ...
        {!isSidebarOpen && (
          <div
            className="absolute rounded-lg border border-gray-1 top-80 ml-20
bg-white w-44 text-base
invisible opacity-20 -translate-x-3 transition-all
group-hover:visible group-hover:opacity-100 group-hover:translate-x-0 z-50  shadow-bottom"
          >
      ...
      <li className="group">
        <div
          ...
          className={`flex items-center justify-between mt-2 py-2 px-2 hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
            isPayrollOpen ? "bg-[#DAEFF8] text-[#0D2282]" : " text-[#5C5E64]"
          } ${isSidebarOpen ? "rounded-t-lg" : "rounded-lg"} cursor-pointer`}
        >
          <div className="flex flex-col justify-center">
          ...
          >
            ...
            <FaAngleDown
              className={`text-xs transition-transform duration-300 ${
                isPayrollOpen ? "transform rotate-180" : ""
              }`}
            />
          </div>
        </div>
      ...
      <li className="group">
        ...
        >
          ...
          >
            ...
            <FaAngleDown
              className={`text-xs transition-transform duration-300 ${
                isPeopleEngagementOpen ? "transform rotate-180" : ""
              }`}
            />
          </div>
        </div>
        {!isSidebarOpen && (
          <div
            className="absolute rounded-lg border border-gray-1 top-96 ml-20
bg-white w-44 text-base
invisible opacity-20 -translate-x-3 transition-all
group-hover:visible group-hover:opacity-100 group-hover:translate-x-0 z-50  shadow-bottom"
          >
      ...
      <li className="group">
        ...
        >
          ...
          >
            ...
            <FaAngleDown
              className={`text-xs transition-transform duration-300 ${
                isPersonalDevelopmentOpen ? "transform rotate-180" : ""
              }`}
            />
          </div>
        </div>
...
group-hover:visible group-hover:opacity-100 group-hover:translate-x-0 z-50  shadow-bottom"
      ...
      <NavLink
        to="/coming-soon"
        className={({ isActive }) =>
          `group flex rounded-md py-2 px-2 items-center gap-x-2 text-[#5C5E64] hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
            isActive ? "bg-[#DAEFF8] text-[#0D2282]" : ""
          }`
        }
      >
        <div className="flex flex-col">
          ...
          <p
            className={`text-xs ml-1 text-center transition-opacity duration-300 ${
              isSidebarOpen
                ? "hidden"
                : "hidden group-hover:block group-hover:opacity-100"
            }`}
    ...
    >
      ...
      <li className="group">
        <div
          ...
          className={`flex items-center justify-between my-2 py-2 px-2 hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
            isLeaveOpen ? "bg-[#DAEFF8] text-[#0D2282]" : "text-[#5C5E64]"
          } rounded-lg cursor-pointer`}
        >
          <BiTask
            className={`text-xl mr-2 ${!isSidebarOpen ? "ml-[10px]" : ""}`}
          />
          <div
            className={`flex items-center gap-x-1 flex-grow ${
              isSidebarOpen ? "block" : "hidden"
          ...
          >
            ...
            <FaAngleDown
              className={`text-xs transition-transform duration-300 ${
                isDtrOpen ? "transform rotate-180" : ""
              }`}
            />
          </div>
        </div>
        {!isSidebarOpen && (
          <div
            className="absolute rounded-md top-72 ml-20
          ...
          >
            <div className="flex flex-col rounded-lg bg-white">
              <li>
                <Link to="/create-task">
                  <div
                    className={`flex rounded-md mx-1 my-1 py-2 px-2 items-center gap-x-1 hover:bg-[#DAEFF8] hover:text-[#0D2282] ${
