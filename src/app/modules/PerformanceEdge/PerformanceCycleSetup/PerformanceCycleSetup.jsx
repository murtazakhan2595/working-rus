...
import { getPerformanceCycleList, } from "app/hooks/performanceEdge";
...
import { PerformanceCycleColumns } from "app/modules/PerformanceEdge/GenerateForm/Sections";
                ...
                <CardContent>
                    ...
                    {isLoading ? (
                        ...
                        <TableCustom
                            ...
                            columns={PerformanceCycleColumns(fetchData)}
                            pagination={true}
