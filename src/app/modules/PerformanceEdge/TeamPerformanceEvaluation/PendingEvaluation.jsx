...
import { getManagerPendingEvaluation } from "app/hooks/performanceEdge";
...
import { ManagerPendingEvaluationColumns } from "app/modules/PerformanceEdge/Sections";
...
const PendingEvaluation = ({ reload }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await getManagerPendingEvaluation({
                filterData: filter,
                options,
                ordering,
            });
            ...
            <CardContent>
                ...
                {isLoading ? (
                    ...
                    <TableCustom
                        ...
                        columns={ManagerPendingEvaluationColumns(fetchData)}
                        pagination={true}
