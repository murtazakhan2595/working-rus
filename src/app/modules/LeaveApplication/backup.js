    ...
    <div className="bg-[#F9F9F9] w-full">
      ...
      <div className="px-3 lg:px-7 h-[76vh] h md:h-[83vh] lg:h-[80vh] overflow-y-scroll scroll">
        ...
        <form onSubmit={handleSubmit}>
          <div>
            <div className="flex items-center justify-between py-2 md:justify-normal gap-6 lg:gap-12">
              <label
            ...
            <div className="flex flex-col md:flex-row justify-between md:justify-normal  gap-x-20">
              <div className="flex flex-col md:w-[41%]">
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-[6.5rem]">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
                ...
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-[5.5rem]">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
                ...
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-10">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
              ...
              <div className="flex flex-col md:w-[41%]">
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-32">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
                ...
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-16">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
                ...
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-[4.5rem]">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
            ...
            <div className="py-2 flex items-center justify-between md:justify-normal md:gap-x-7 lg:gap-x-12">
              <div
                className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
              >
            ...
            <div className="py-2 flex items-center justify-between md:justify-normal gap-x-14 lg:gap-x-[4.8rem]">
              <label
                className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
              >
            ...
            <div className="flex flex-col md:flex-row md:gap-x-20">
              <div className="flex flex-col md:w-[41%]">
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-14">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
                ...
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-5">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
                ...
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-9">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
              ...
              <div className="flex flex-col md:w-[44%]">
                <div className="py-2 flex items-center justify-between md:gap-x-20 md:justify-normal lg:gap-x-[5.5rem]">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
                ...
                <div className="py-2 flex items-center justify-between lg:justify-normal lg:gap-x-12">
                  <label
                    className="font-sfpro tracking-wide font-semibold
                            text-input text-base"
                  >
                ...
                <div className="py-2 flex items-center md:gap-x-6 lg:justify-normal lg:gap-x-7">
                  <label
                    className="font-sfpro tracking-wide font-semibold
            ...
            <div className="py-2 flex items-center justify-between md:justify-normal lg:justify-normal md:gap-x-2 lg:gap-x-[16px]">
              <label
                className="font-sfpro tracking-wide font-semibold
