...
const LeaveBalance = ({ baseUrl, token, userProfile }) => {
  return (
    <div className="bg-[#F9F9F9] w-full">
      ...
      <div className="flex items-center justify-center mx-1 md:mx-2 lg:mx-8 gap-x-2">
        <h2 className="text-[#343434] font-semibold w-[70%] md:w-[87%] lg:w-[69.5%] rounded-tl-md rounded-bl-lg py-1 bg-[#F2F2F2] text-lg text-center">
          Employee Data
        </h2>
        <h2 className="text-[#343434] font-semibold w-[30%] md:w-[13%] lg:w-[30.5%] rounded-tr-md rounded-br-lg py-1 bg-[#F2F2F2] text-lg text-center">
          Leave Data
        </h2>
      </div>
      <div className="px-1 py-4 md:p-3 md:py-3 lg:px-8 lg:py-1 overflow-x-auto overflow-y-auto max-h-[60.5vh] md:max-h-[75.5vh] lg:max-h-[70vh] roundScroll">
        <table className="min-w-full">
          <thead>
            <tr className="text-baseBlue bg-[#F2F2F2] whitespace-nowrap">
              <th className="px-6 py-3 text-left rounded-tl-lg">Code</th>
              ...
              <th className="px-4 py-3 text-left">Alloted</th>
              <th className="px-4 py-3 text-left">Used</th>
              <th className="px-4 py-3 text-left rounded-tr-lg">Left</th>
            </tr>
          </thead>
          <tbody className="bg-white text-gray-500">
            <tr
              ...
              //   key={user.id}
            >
              <td className="px-6 py-2 text-left">1234</td>
              <td className="px-6 py-2 text-left">Syed Umair</td>
              <td className="px-6 py-2 text-left">Development</td>
              <td className="px-6 py-2 text-left">React Developer</td>
              <td className="px-3 py-2 text-left">Asra Fatima</td>
              <td className="px-4 py-2 text-left">Sick</td>
              <td className="px-4 py-2 text-left flex items-center gap-x-2">
                <div className="text-sm">&#9664;</div>
                23
                <div className="text-sm">&#9654;</div>
              </td>
              <td className="px-4 py-2 text-left">50</td>
