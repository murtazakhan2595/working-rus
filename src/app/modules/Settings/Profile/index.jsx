...
import {getEmployeeVisaDetailData , getEmployeeCerficationData ,getEmployeeData,getEmployeeProfessionalExperianceData,getEmployeeAcademicRecordData,getEmployeeVisaDetailsFiles} from '../../../hooks/employee'
...
const ViewEmployee = ({ token, baseUrl ,userProfile }) => {
