        ...
        <table className="min-w-full">
          <thead>
            <tr className="text-baseBlue bg-[#F2F2F2] whitespace-nowrap">
              ...
              <th className="flex gap-x-2 items-center px-6 py-3 text-left  rounded-tl-lg">Job Title
              ...
              <th className="px-6 py-3 text-center rounded-tr-lg">Total Applications</th>
            </tr>
          </thead>
          <tbody className="bg-white text-gray-500">
            {posts.map((post) => (
              <tr className="whitespace-nowrap border-b-2 hover:bg-gray-100" key={post.id}>
                ...
                <td className="px-6 py-3 text-left">{formatDate(post.created_at)}</td>
                <td className="px-6 py-3 text-left">{formatDate(post.Deadline)}</td>
                <td className="px-6 py-3 text-left"><a className="underline text-blue-600" href="">linked.com</a></td>
                <td className="px-6 py-3 text-center">{post.total_applications}</td>
              </tr>
            ))}
