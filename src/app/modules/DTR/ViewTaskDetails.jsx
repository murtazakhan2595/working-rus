...
const ViewTaskDetails = ({hoveredTask, setShowHoveredTask, statusIcons, getReportingManager, statusStyles}) => {
    return (
        <div className="absolute top-0 right-0 w-[37%] h-full bg-white shadow-lg z-10 p-10">
            ...
            <div className="text-xl lg:mb-4 font-semibold font-lato text-baseGray">{hoveredTask.task}</div>
            <div className="flex items-center justify-between gap-x-5">
                ...
                <div className="flex items-center gap-x-5 text-sm">
                    ...
                    <div className="flex flex-col gap-y-3 w-[60%]">
                        <div className="text-baseGray flex items-center gap-x-2 h-9">
                            <h3 className="font-medium font-lato bg-purple-600 text-white w-8 h-8 rounded-full flex justify-center items-center">{getReportingManager(hoveredTask.assigne)}</h3>
                        </div>
                        <div className="text-baseGray flex items-center gap-x-2 h-9">
            ...
            <div className="text-lg lg:mt-2 lg:mb-2 font-semibold font-lato text-baseGray">Task Details</div>
            <div className="text-baseGray font-lato">{hoveredTask.task_details}</div>
