    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="w-full max-w-2xl p-10 bg-white rounded-lg shadow-md">
        ...
        <div className="text-center">
          <h2 className="mb-3 text-2xl font-bold text-neutral-1200">Oops! Looks like you're lost</h2>
          <p className="mb-8 text-neutral-1000">
            The page you're looking for seems to have wandered off. Don't worry, we'll help
