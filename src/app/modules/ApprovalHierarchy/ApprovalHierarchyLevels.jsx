  ...
  return (
    ...
    >
      <Header
        ...
        content={<Button>Add Levels</Button>}
      />
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 grid-cols-1 md:grid-cols-3 lg-grid-cols-5">
            <DetailBox value={formData.name} label="name" />
            <DetailBox
              value={
            ...
            />
            <DetailBox
              value={`${formValues.auto_forward_threshold}hr`}
...
export default ApprovalHierarchyLevels;
