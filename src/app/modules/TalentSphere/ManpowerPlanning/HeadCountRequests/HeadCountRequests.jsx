...
const HeadCountRequests = ({ isTeamView = false, activeView = "Requests" }) => {
    const {
        id: user_id,
            ...
            <CardHeader className="flex flex-row justify-between items-center gap-4">
                <div>
                    ...
                    <CardDescription className="text-neutral-1100">
                        Here you can {activeTab === 'Requests' ? 'view' : 'approve, or reject'} manpower headcount requests submitted by branch managers, so that the organization can maintain controlled manpower allocation and update department-wise headcount automatically upon approval.
                    </CardDescription>
                </div>
            </CardHeader>
...
export default HeadCountRequests;
