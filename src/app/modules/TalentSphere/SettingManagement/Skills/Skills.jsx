...
import { getSkillList } from "app/hooks/talentSphere";
import { CardContent } from "components/ui/card";
import { SkillsColumns } from "app/modules/TalentSphere/Sections";
        ...
        <>
            ...
            <CardContent>
                {isLoading ? (
                    ...
                    <TableCustom
                        columns={SkillsColumns(fetchData)}
                        data={filteredData}
                        tableOptions={tableOptions}
                        dataTotalSize={SkillList?.count || 0}
                        pagination={true}
