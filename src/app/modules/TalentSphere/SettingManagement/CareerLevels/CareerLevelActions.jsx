...
import {AddUpdateCareerLevelForm} from "app/modules/TalentSphere";
import DropdownActionMenu from "components/DropdownActionMenu";
import { HasAccess } from "utils/PermissionUtils";

const CareerLevelActions = ({ data, DataList = [], reloadData = () => { } }) => {
    const isEditPermitted = HasAccess("EDIT_TS_CAREER_LEVEL");
    const isDeletePermitted = HasAccess("DELETE_TS_CAREER_LEVEL");
    ...
    return (
        <>
            <DropdownActionMenu
                ...
                viewText="View Career Level"
                editText="Edit Career Level"
                deleteText="Delete Career Level"
                menuTooltip="Checklist Career Level"
            />
...
export default CareerLevelActions;
