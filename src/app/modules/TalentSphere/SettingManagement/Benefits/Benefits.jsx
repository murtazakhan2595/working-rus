...
import { getBenefitList } from "app/hooks/talentSphere";
import { CardContent } from "components/ui/card";
import { BenefitsColumns } from "app/modules/TalentSphere/Sections";
import { FilterInput } from "components/FormControl";
import { CardHeader, CardTitle, CardDescription } from "components/ui/card";

const Benefits = ({ reload }) => {
        ...
        <>
            ...
            <CardContent>
                {isLoading ? (
                    ...
                    <TableCustom
                        columns={BenefitsColumns(fetchData)}
                        data={filteredData}
                        tableOptions={tableOptions}
                        dataTotalSize={BenefitList?.count || 0}
                        pagination={true}
