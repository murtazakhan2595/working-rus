...
import {AddUpdateBenefitForm} from "app/modules/TalentSphere";
import DropdownActionMenu from "components/DropdownActionMenu";
import { HasAccess } from "utils/PermissionUtils";

const BenefitActions = ({ data, DataList = [], reloadData = () => { } }) => {
    ...
    const confirmDelete = async () => {
        try {
            await deleteRecord(`/recruitment-benefits/${data.id}`, `${data.name}`);
            setDeleteForm(null);
            reloadData(true);
        } catch (error) {
    ...
    return (
        <>
            <DropdownActionMenu
                ...
                viewText="View Benefit"
                editText="Edit Benefit"
                deleteText="Delete Benefit"
                menuTooltip="Benefit Actions"
            />
