...
import { Header, OverviewCard, PageLoader, DetailContent, StatusLabel } from "components";
...
export default function ApplicantProfileDetails() {
    ...
    return (
        <div className="flex flex-col gap-4">
            <Header showBackButton={true} navigationLink={'/talent-sphere/applicants-profile'} />
            <Card>
