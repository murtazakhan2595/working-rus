...
import { Command, CommandInput, CommandList, CommandItem, CommandEmpty, CommandGroup } from "src/@/components/ui/command";
    ...
    <div className={classes}>
      ...
      <Popover open={open} onOpenChange={setOpen}>
                ...
                {value.length > 0 ? (
                  value.map((val) => (
                    ...
                    >
                      ...
                      {/* <CircleX className="ml-1 text-sm text-red-600 cursor-pointer" onClick={(e) => { e.stopPropagation(); handleRemove(val); }} /> */}
                    </span>
                  ))
                ) : (
                  <span className="text-sm font-normal text-neutral-1000">Select</span>
                )}
              </div>
        ...
        <PopoverContent className="w-[300px] p-0">
          <Command>
            <CommandInput placeholder="Search options..." className="text-sm font-normal text-neutral-900" />
            <CommandList>
